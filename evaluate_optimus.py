...
from optimus.examples.big_ae.run_latent_generation import analogy, interpolate
...
if __name__ == '__main__':
    ...
    dic = {
        ...
        'pretrain_model_path': './checkpoints/optimus/optimus_32_rec_loss_1_08_100',
        ...
        'pt_lm':'t5-small',
        'save_dir': 'checkpoints/optimus_32_inf_loss_0.82_50',
        'seed':0,
        'w2v_weights':None
    }
