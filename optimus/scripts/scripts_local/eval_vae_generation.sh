...
export TRAIN_FILE=../data/datasets/tt-data-1.csv
export TEST_FILE=../data/datasets/tt-data-1.csv
...
CUDA_VISIBLE_DEVICES=$GPU_ID /usr/local/bin/python3.7 examples/big_ae/run_encoding_generation.py \
